...
- The `boot-up process <https://docs.espressif.com/projects/esp-idf/en/v4.4.1/esp32c3/api-guides/startup.html>`_ of the ESP-IDF application stays the same. ``app_main`` is essentially the entry point of our protected app.
