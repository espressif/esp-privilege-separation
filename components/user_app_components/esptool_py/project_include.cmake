...
set(esptool_dir ${idf_path}/components/esptool_py)
...
set(ESPTOOLPY ${python} "${esptool_dir}/esptool/esptool.py" --chip ${chip_model})
set(ESPSECUREPY ${python} "${esptool_dir}/esptool/espsecure.py")
set(ESPEFUSEPY ${python} "${esptool_dir}/esptool/espefuse.py")
